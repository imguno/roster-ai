...
const (
	Worker_Execute_FullMethodName = "/roster.worker.v1.Worker/Execute"
)
...
var Worker_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "roster.worker.v1.Worker",
